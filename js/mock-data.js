...
const MockData = (() => {
  ...
  const matches = [
    ...
    },
    {
      ...
      equipo1: 'Deportivo Asociación Cultural del Norte',
      equipo2: 'Club Atlético Independiente del Sur',
      estado: 'en-vivo',
      minuto: "23'",
      scoreEquipo1: 1,
      scoreEquipo2: 1,
    ...
    /* ─────────── FINALIZADOS ─────────── */
    {
      id: 'm9',
      liga: 'La Liga',
      equipo1: 'Unión Deportiva Internacional de Valencia',
      equipo2: 'Sevilla FC',
      estado: 'finalizado',
      scoreEquipo1: 2,
      scoreEquipo2: 1,
      fecha: '2026-04-12T20:00:00',
      // pred 2-1 vs real 2-1 -> marcador exacto -> +3 pts
      userPred: { scoreEquipo1: 2, scoreEquipo2: 1, estado: 'acierto', puntos: 3, exacto: true },
    },
    {
      id: 'm10',
      liga: 'Champions League',
      ...
      // pred 2-0 vs real 1-0 -> resultado correcto (equipo 1) -> +1 pt
      userPred: { scoreEquipo1: 2, scoreEquipo2: 0, estado: 'acierto', puntos: 1 },
    },
    {
      id: 'm11',
      liga: 'Premier League',
      equipo1: 'Tottenham Hotspur',
      equipo2: 'Newcastle United',
      estado: 'finalizado',
      scoreEquipo1: 3,
      scoreEquipo2: 1,
      fecha: '2026-04-12T17:30:00',
      // pred 2-1 vs real 3-1 -> resultado correcto (equipo 1) -> +1 pt
      userPred: { scoreEquipo1: 2, scoreEquipo2: 1, estado: 'acierto', puntos: 1 },
    },
    {
      id: 'm12',
      liga: 'Copa Libertadores',
      ...
      userPred: { scoreEquipo1: 1, scoreEquipo2: 0, estado: 'fallo', puntos: 0 },
    },
  ];
  ...
  const userPredictions = matches
    ...
    .map(m => ({
      ...
      equipo2: m.equipo2,
      liga: m.liga,
      scoreEquipo1Pred: m.userPred.scoreEquipo1,
      scoreEquipo2Pred: m.userPred.scoreEquipo2,
